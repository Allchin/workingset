...
public class FalseSharing7Martin implements Runnable {
	...
	public FalseSharing7Martin(final int arrayIndex) {
	...
	private static void runTest() throws InterruptedException {
		...
		for (int i = 0; i < threads.length; i++) {
			threads[i] = new Thread(new FalseSharing7Martin(i));
		}
