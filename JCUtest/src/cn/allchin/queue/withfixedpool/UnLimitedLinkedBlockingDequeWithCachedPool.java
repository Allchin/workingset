 ...
 *
 */
public class UnLimitedLinkedBlockingDequeWithCachedPool implements QueueThreadPoolCreater {
	...
	public static void main(String[] args) {
		PoolRunner.testOne(new UnLimitedLinkedBlockingDequeWithCachedPool());
	}
